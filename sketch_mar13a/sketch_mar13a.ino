...
const char* apikey = "KPAFXBMPB97UXIF1";

void setup() {
    // Inicializa o pino digital LED_BUILTIN como saída
    pinMode(LED_BUILTIN, OUTPUT);

    // Inicializa a comunicação serial com velocidade de 9600 bps (bits por segundo)
    Serial.begin(9600);
    ...
    while (WiFi.status() != WL_CONNECTED) {
        ...
        Serial.print(".");
        Serial.println("Status do Wi-Fi: " + String(WiFi.status())); // Imprime um ponto na saída serial a cada tentativa
    }
